...
// Render current VBObox contents.
  ...
  mat4.translate(this.mvpMat, this.mvpMat, vec3.fromValues(0,5,1.3));
  mat4.rotate(this.mvpMat, this.mvpMat, 0.40*Math.PI, vec3.fromValues(1,0,0));
  ...
  mat4.translate(this.mvpMat, this.mvpMat, vec3.fromValues(5, 1.0, 1.3));
  ...
  mat4.copy(this.mvpMat, tmp); // RESTORE current value (needs push-down stack!)
  mat4.translate(this.mvpMat, this.mvpMat, vec3.fromValues(0,-4,1));
  // Send  new 'ModelMat' values to the GPU's 'u_ModelMat1' uniform: 
  gl.uniformMatrix4fv(this.u_mvpMatLoc,	// GPU location of the uniform
  										false, 				// use matrix transpose instead?
  										this.mvpMat);	// send data from Javascript.
  ...
  mat4.copy(this.mvpMat, tmp); // RESTORE current value (needs push-down stack!)
  mat4.translate(this.mvpMat, this.mvpMat, vec3.fromValues(1,-2,1));
  ...
  mat4.copy(this.mvpMat, tmp);      // restore world-space mvpMat values.
    gl.drawArrays(gl.LINE_STRIP, 	      // select the drawing primitive to draw,
                  ...
                  this.vboVerts - this.bgnSphere); // How many vertices to draw
  mat4.copy(this.mvpMat, tmp); // RESTORE current value (needs push-down stack!)  
  // 5)--------------------copy transforms for Sphere 3 in CScene.initScene(0)
  mat4.copy(this.mvpMat, tmp); // RESTORE current value (needs push-down stack!)
  mat4.translate(this.mvpMat, this.mvpMat, vec3.fromValues(-1,-2,1));
  ...
  mat4.copy(this.mvpMat, tmp); // RESTORE current value (needs push-down stack!) 
    ...
    // 3)--------------------copy transforms for Sphere 1 in CScene.initScene(0)
    mat4.copy(this.mvpMat, tmp); // RESTORE current value (needs push-down stack!)
    mat4.translate(this.mvpMat, this.mvpMat, vec3.fromValues(-1,0,1));
    ...
    mat4.scale(this.mvpMat, this.mvpMat, vec3.fromValues(0.67,0.67,0.67));
    ...
    mat4.copy(this.mvpMat, tmp); // RESTORE current value (needs push-down stack!)
    mat4.translate(this.mvpMat, this.mvpMat, vec3.fromValues(1, 0, 1));
    mat4.scale(this.mvpMat, this.mvpMat, vec3.fromValues(0.33,0.33,0.33));
    ...
    // 4)--------------------copy transforms for Sphere 2 in CScene.initScene(0)
    mat4.copy(this.mvpMat, tmp); // RESTORE current value (needs push-down stack!)
    mat4.translate(this.mvpMat, this.mvpMat, vec3.fromValues(1,-2,4));
    mat4.scale(this.mvpMat, this.mvpMat, vec3.fromValues(0.75,0.75, 0.75));
    ...
    // 5)--------------------copy transforms for Sphere 3 in CScene.initScene(0)
    mat4.copy(this.mvpMat, tmp); // RESTORE current value (needs push-down stack!)
    mat4.translate(this.mvpMat, this.mvpMat, vec3.fromValues(0,0,2));
    mat4.scale(this.mvpMat, this.mvpMat, vec3.fromValues(0.25,0.25, 0.25));
    ...
    // 3)--------------------copy transforms for Sphere 1 in CScene.initScene(0)
    mat4.copy(this.mvpMat, tmp); // RESTORE current value (needs push-down stack!)
    mat4.translate(this.mvpMat, this.mvpMat, vec3.fromValues(0,0,4));
    // Send  new 'ModelMat' values to the GPU's 'u_ModelMat1' uniform: 
    gl.uniformMatrix4fv(this.u_mvpMatLoc,	// GPU location of the uniform
                        false, 				// use matrix transpose instead?
                        this.mvpMat);	// send data from Javascript.
    ...
    // 4)--------------------copy transforms for Sphere 2 in CScene.initScene(0)
    mat4.copy(this.mvpMat, tmp); // RESTORE current value (needs push-down stack!)
    mat4.translate(this.mvpMat, this.mvpMat, vec3.fromValues(0,2,2));
    mat4.scale(this.mvpMat, this.mvpMat, vec3.fromValues(0.67,0.67,0.67));
    ...
    // 5)--------------------copy transforms for Sphere 3 in CScene.initScene(0)
    mat4.copy(this.mvpMat, tmp); // RESTORE current value (needs push-down stack!)
    mat4.translate(this.mvpMat, this.mvpMat, vec3.fromValues(0,0,0.5));
    mat4.scale(this.mvpMat, this.mvpMat, vec3.fromValues(0.33,0.33,0.33));
