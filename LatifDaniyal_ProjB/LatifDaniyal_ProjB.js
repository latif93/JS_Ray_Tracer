...
function onRecurseDepthButton(){
  recurseDepth +=1;
  recurseDepth = recurseDepth % 9;
  document.getElementById('RDreport').innerHTML = "Recursion Depth: " +
  recurseDepth;

}

function onlightOneOnButton(){
  if(lightOneOn){
    lightOneOn = false;
  }
  else{
...
//=============================================================================
  ...
  mySceneNum ++;
  mySceneNum = mySceneNum % 4;
	document.getElementById('SceneReport').innerHTML =
  			'Show Scene Number' + mySceneNum;
 ...
 // g_myPic.setTestPattern(g_SceneNum);
  ...
  if(mySceneNum == 2){
  g_myScene.initScene(2);
  }
  else if(mySceneNum == 0){
